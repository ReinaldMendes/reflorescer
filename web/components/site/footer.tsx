...
export function Footer() {
  return (
    <footer className="border-t border-brand-100 bg-brand-800 text-bg">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-4 lg:px-12">
        <div>
          <p className="font-display text-2xl">Reflorescer</p>
        ...
        <div>
          <p className="mb-4 text-sm font-medium uppercase tracking-wide text-brand-200">Loja</p>
        ...
        <div>
          <p className="mb-4 text-sm font-medium uppercase tracking-wide text-brand-200">Atendimento</p>
          <ul className="space-y-2 text-sm text-brand-100">
        ...
        <div>
          <p className="mb-4 text-sm font-medium uppercase tracking-wide text-brand-200">Contato</p>
          <ul className="space-y-2 text-sm text-brand-100">
