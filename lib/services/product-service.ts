...
// Camada de serviço — isola regras de negócio da camada HTTP (route handlers
// / server actions). Isso permite reaproveitar a mesma lógica no admin,
// no site público e em scripts (seed, jobs futuros) sem duplicação.
