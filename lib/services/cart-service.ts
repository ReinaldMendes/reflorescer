...
// Carrinho identificado por sessionId (cookie) para visitantes, e por
// customerId quando o cliente está autenticado. A migração de carrinho
// de visitante -> cliente (no login) é feita em mergeCartOnLogin.
