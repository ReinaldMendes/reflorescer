...
export async function applyCoupon(code: string, subtotal: number, productIds: string[]) {
  ...
  // Se o cupom for restrito a produtos específicos, valida que ao menos
  // um item do carrinho esteja no escopo permitido.
  ...
  // FREE_SHIPPING é tratado à parte no cálculo de frete (order-service)
